...
SOURCEFILES_QUOTED_IF_SPACED=main.s.s

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/main.s.o
POSSIBLE_DEPFILES=${OBJECTDIR}/main.s.o.d

# Object Files
OBJECTFILES=${OBJECTDIR}/main.s.o

# Source Files
SOURCEFILES=main.s.s
...
MP_PROCESSOR_OPTION=PIC16F88
FINAL_IMAGE_NAME_MINUS_EXTENSION=${DISTDIR}/lab2.X.${IMAGE_TYPE}
# ------------------------------------------------------------------------------------
# Rules for buildStep: pic-as-assembler
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
${OBJECTDIR}/main.s.o: main.s.s  nbproject/Makefile-${CND_CONF}.mk 
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} ${OBJECTDIR}/main.s.o 
	${MP_AS} -mcpu=PIC16F88 -c \
	-o ${OBJECTDIR}/main.s.o \
	main.s.s \
...
${DISTDIR}/lab2.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	@${MKDIR} ${DISTDIR} 
	${MP_LD} -mcpu=PIC16F88 ${OBJECTFILES_QUOTED_IF_SPACED} \
	-o ${DISTDIR}/lab2.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX} \
